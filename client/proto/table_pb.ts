...
export class Table extends Message<Table> {
  ...
  /**
   * @generated from field: cruce.GameMode mode = 3;
   */
  mode = GameMode.GAME_MODE_1_V_1;

  /**
   * @generated from field: cruce.Points points = 4;
   */
  points = Points.POINTS_6;

  /**
   * @generated from field: cruce.Time time = 5;
   */
  time = Time.TIME_5S;

  /**
   * @generated from field: bool iber = 6;
   */
  iber = false;

  /**
   * @generated from field: bool cheating = 7;
   */
  cheating = false;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "mode", kind: "enum", T: proto3.getEnumType(GameMode) },
    { no: 4, name: "points", kind: "enum", T: proto3.getEnumType(Points) },
    { no: 5, name: "time", kind: "enum", T: proto3.getEnumType(Time) },
    { no: 6, name: "iber", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 7, name: "cheating", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 8, name: "password", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ]);
